...
<!-- /container -->
<div :class="['content',{'action5':action5}]">
  <header class="codrops-header">
    <h1 class="codrops-header__title"></h1>
    <button class="btn btn--info btn--toggle"></button>
    <button class="btn btn--menu btn--toggle"></button>
  ...
  <div class="slides">
    ...
    <nav class="nav">
        <button class="btn btn--nav btn--nav-left btn-left" id="btnleft" >
            <img class="btnpic vm g10" src="../public/images/prev.png" alt="">
        </button>
        <button class="btn btn--nav btn--nav-right btn-right" id="btnright">
